...
%enables these objects to collect and exchange data.” – International 
%Telecommunication Union (ITU)/Wikipedia, 2014
%
%“A proposed development of the Internet in which everyday objects have network 
%connectivity, allowing them to send and receive data.” – Oxford University, 
%2014
%
%no fixed definition
%
%big Buzzword with different stakeholders
...
%IoT is great and will be the future - point is not to destroy IoT. Just please 
%consider security as this might lead to serious problems.

%it can be stated that currently there is a lack of expierence and will to deal 
%with security properly. it seems developers tend to invest more time in new 
%features than into security. this shown by the HP study and the unwilligness 
%of 
%the manufaturers to deal with the unsolved patching problem
%why is it like that?
%no experience? no will? it seems there is a lack of expierence on security 
%issues among IoT developers. because these are beginners faults
% either no know how or no will/time.

% if it is lack of experience: there are means to get information -> OWASP

% if it is lack of will: security should be done now - include it in the design 
%-> later implementation 
%very complicated and normally costs a lot or is even infeasible
%it's cheaper to implement security now - one might think it's easier to think 
%about security later -> has proven to be false, see also Jeep Cherokee 
%example. 

%IoT bears a lot of opportunities but security should be considered
%
%developers of IoT lack expierence in security
%
%security should be considered when designing IoT devices
%
%What do we want to interconnect/connect to the Internet?


%aus ct: 
%	S.80, Abschnitt Neuland ff.
%		alles wird ins Internet gesetzt -> ist das wirklich gut?
%		es braucht ein Umdenken der gesamten Branche			
%still a lot of work, research
